...
@ stub -version=0x601+ AddDllDirectory
...
@ stub -version=0xA00+ QueryOptionalDelayLoadedAPI
@ stub -version=0x601+ RemoveDllDirectory
@ stub -version=0x601+ SetDefaultDllDirectories
